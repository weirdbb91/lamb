...
$(document).ready(function () {
    $('#btn_post').on('click', function () {
        var result = API_post("POST");            
        $('#presentor').val(result);
     });


    $('#btn_put').on('click', function () {
        var result = API_post("PUT");            
        $('#presentor').val(result);
     });


    $('#btn_delete').on('click', function () {
        var result = API_post("DELETE");            
        $('#presentor').val(result);
     });


    $('#btn_get').on('click', function () {
        var result = API_post("GET");            
        $('.presenter').append(result);
     });
})
...
function API_post(method) {
    
    var result = API_request(method,
        $('#post_url').val(),
        $('#post_id').val(),
        $('#post_memberId').val(),
        $('#post_title').val(),
    ...
    function API_request(method, url, id, memberId, title, content) {
    
    $('.post_request').append(`${method} ${id} ${memberId} ${title} ${content}`);
    ...
    return API_JSON_Body(method, url, request);
}
